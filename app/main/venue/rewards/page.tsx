          ...
          <div style={{ backgroundColor: theme.surface, borderRadius: '16px', border: `1px solid ${theme.divider}`, padding: '14px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              <button
                ...
                style={{ flex: 1, backgroundColor: theme.accent, color: 'white', border: 'none', borderRadius: '9999px', padding: '10px 20px', fontSize: '14px', fontWeight: 600, cursor: creating || !newName.trim() ? 'default' : 'pointer', opacity: creating || !newName.trim() ? 0.6 : 1, fontFamily: 'Montserrat, system-ui, sans-serif' }}
              >
